              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form method="post" action="<?php echo base_url('auth/login') ?>" class="user">
                    ...
                    <button type="submit" action="post" class="btn btn-primary form-control">Login</button>
                  </form>
                  <hr>
                  <div class="text-center">
                    <a class="small" href="<?php echo base_url('registrasi/index') ?>">Buat Akun Disini!</a>
                  </div>
                </div>
              </div>
            </div>
